...
Extensão da v5_alerts:
- Introduz controle de estado do wearable
- Detecta carregamento via variação da bateria
- Evita alertas falsos durante carregamento ou remoção
Estados:
- IN_USE
- CHARGING
- REMOVED
